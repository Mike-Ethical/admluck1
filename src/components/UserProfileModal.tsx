      ...
      <div className="bg-[#0e131e] border border-[#1f2a3f] rounded-2xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="p-4 bg-[#141c2c] border border-[#1e2a42] rounded-xl flex items-center gap-3.5 relative overflow-hidden">
            <div className="relative shrink-0">
              ...
              {isOwner ? (
                ...
                <span className="absolute bottom-0 right-0 w-3.5 h-3.5 rounded-full bg-[#00f090] border-2 border-[#141c2c] shadow-[0_0_8px_#00f090]" />
              )}
            </div>
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {!isOwner && (
                  <span className="px-2 py-0.5 rounded bg-[#00f090]/20 border border-[#00f090]/40 text-[#00f090] text-[10px] font-gaming font-black uppercase">
                    VERIFIED
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {user.robloxUserId && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-[11px] text-[#00f090] hover:underline flex items-center gap-0.5 font-gaming"
                  >
                    <span>View</span>
              ...
              <div className="flex items-center gap-1.5 mt-1.5">
                ...
                <span className={`text-xs font-mono font-black ${user.totalProfit >= 0 ? 'text-[#00f090]' : 'text-rose-400'}`}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <div className="p-2.5 rounded-xl bg-[#121826] border border-[#1b2539] flex flex-col">
              <span className="text-[10px] font-gaming text-slate-400 uppercase flex items-center gap-1">
                <Percent className="w-3 h-3 text-[#00f090]" />
                Win Rate
              </span>
              <span className="text-sm font-mono font-bold text-[#00f090] mt-0.5">
                {winRate}%
              </span>
            </div>
