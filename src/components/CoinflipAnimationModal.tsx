...
export const CoinflipAnimationModal: React.FC<CoinflipAnimationModalProps> = ({
  ...
  useEffect(() => {
    ...
    // Step 1: Brief countdown & launch pure 3D flip (0.35s)
  ...
  return (
    <div className="fixed inset-0 bg-black/92 backdrop-blur-md z-50 flex items-center justify-center p-4 select-none">
      ...
      {isWaiting ? (
        <div className="bg-[#111620] border border-white/10 rounded-2xl p-8 max-w-sm w-full mx-4 flex flex-col items-center justify-center text-center shadow-2xl animate-scaleIn">
          <Coin3D
          ...
          <div className="flex items-center gap-2 mt-4 text-amber-400 font-gaming font-bold text-xs uppercase tracking-wider">
        ...
        <div className="bg-[#121620] border border-white/10 rounded-2xl p-8 max-w-sm w-full mx-4 flex flex-col items-center justify-center text-center shadow-[0_20px_60px_rgba(0,0,0,0.9)] animate-scaleIn relative">
          ...
          <p className="text-slate-300 text-base font-normal mb-8">
            {isWinnerCurrentUser
              ...
              : isParticipant
              ? 'You Lost This Game.'
              : `${targetWinner.username} Won This Game.`}
          </p>
        ...
        <div className="flex flex-col items-center justify-center select-none relative animate-fadeIn">
          <Coin3D
            rotationY={rotationY}
            rotationX={rotationX}
            height={coinHeight}
