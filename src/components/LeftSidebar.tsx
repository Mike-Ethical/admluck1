...
export const LeftSidebar: React.FC<LeftSidebarProps> = ({
  ...
  return (
    <aside className="hidden lg:flex w-20 bg-[#080c14] border-r border-[#162033] flex-col justify-between items-center py-5 select-none shrink-0 z-20 shadow-[4px_0_24px_rgba(0,0,0,0.4)]">
