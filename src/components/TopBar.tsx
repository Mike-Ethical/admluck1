    ...
    <>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-xs">
          <div className="w-72 max-w-[85vw] h-full bg-[#0e1422] border-l border-[#1d273f] flex flex-col p-4 shadow-2xl select-none animate-in slide-in-from-right duration-200">
            {/* Drawer Header */}
              ...
              {user.verified ? (
                <div className="flex items-center gap-2.5">
                  <div className="relative">
                    ...
                    />
                    <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border border-slate-950 bg-emerald-500" />
                  </div>
                  <div>
